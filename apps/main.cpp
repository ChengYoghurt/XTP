...
int main(int argc,char* argv[]) {
    ...
    #else
    auto p_adapted_api = std::make_unique<wct::api::AdaptedApi>(client_id, filepath, (wct::api::ApiLogLevel)log_level);
